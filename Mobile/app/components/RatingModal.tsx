import {
    View, Text, Modal, TouchableWithoutFeedback, ScrollView, TouchableOpacity, ActivityIndicator,
                                        ...
                                        return (
                                            <View
                                                ...
                                                className={`bg-background-lighter rounded-2xl p-4 
                                                    ${index < (order?.orderItems?.length || 0) - 1 ? "mb-3" : ""}`}
                                            >
